...
const MarqueeItem = () => (
  <div className="flex items-center space-x-12 px-6">
    <span>Creative UI/UX Design</span> <span className="text-teal-400">✦</span>
    <span>Modern Web Development</span> <span className="text-pink-400">✦</span>
    <span>Responsive Mobile Apps</span> <span className="text-amber-400">✦</span>
    <span>Pixel Perfect Code</span> <span className="text-teal-400">✦</span>
    <span>Hyper Scalable Systems</span> <span className="text-pink-400">✦</span>
  </div>
);
          ...
          <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-6 mt-20 w-full max-w-5xl mx-auto">
            ...
            <div ref={linksRef} className="flex flex-col items-center gap-6 w-full">
              ...
              <div className="flex flex-wrap justify-center gap-4 w-full">
                ...
                <MagneticButton 
                  as="a" 
                  href="https://github.com/Jullystian017" 
                  target="_blank" 
